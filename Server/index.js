...
app.use(cors({ 
    origin: 'https://real-time-chat-application-uyhn-pf4widpb7.vercel.app',
    credentials: true,
...
app.use((req, res, next) => {
    res.setHeader('Access-Control-Allow-Origin', 'https://real-time-chat-application-uyhn-pf4widpb7.vercel.app')
